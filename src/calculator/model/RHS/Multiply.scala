...
class Multiply(calculator: Calculator) extends State(calculator) {
  ...
  override def numberPressed(number: Int): Unit = {
    calculator.state = new NumberPressed(calculator, number, new Multiply(calculator))
  }
  ...
  override def decimalPressed(): Unit = {
    calculator.state = new DecimalRHS(calculator, new Multiply(calculator))
  }
